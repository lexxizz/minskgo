...
class MainPage extends React.Component {
    ...
    _feature(e) {
        e.preventDefault();
        return ReactDOM.render(<Feature />, document.getElementById('feature'));
    }
        ...
        return (
            <div>
                <div className="navbar">
                    ...
                    <button className="btn-uni" onClick={this._feature.bind(this)}>
                        <svg className="btn-uni__icon" viewBox="0 0 448.546 448.546" width="86px" height="86px" style={{
fill:'#0050ff',
    transform: 'translate3d(-0.03355407714843661%, 0px, 0px)'}}>
