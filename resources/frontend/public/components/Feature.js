        ...
        return (
            <div className="features">
                ...
                <div className="features__list">
                    ...
                    <li className="features__item features__item--disabled"><i className="fa fa-check-circle-o" aria-hidden="true"></i><span className="features__text">Личный кабинет</span><span className="features__text features__text--gray">(май)</span></li>
                    <li className="features__item features__item--disabled"><i className="fa fa-check-circle-o" aria-hidden="true"></i><span className="features__text">Возможность добавлять в избранное</span><span className="features__text features__text--gray">(май)</span></li>
                    <li className="features__item features__item--disabled"><i className="fa fa-check-circle-o" aria-hidden="true"></i><span className="features__text">Возможность делиться с друзьями</span><span className="features__text features__text--gray">(май)</span></li>
                    <li className="features__item features__item--disabled"><i className="fa fa-check-circle-o" aria-hidden="true"></i><span className="features__text">Индивидуальная email-рассылка</span><span className="features__text features__text--gray">(май)</span></li>
